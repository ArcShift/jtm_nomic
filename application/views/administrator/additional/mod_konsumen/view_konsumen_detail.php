                ...
                <div class='box-body'>
                  ...
                  <div class='panel-body'>
                    <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                      ...
                      <li role='presentation' class=''><a href='#toko' role='tab' id='toko-tab' data-toggle='tab' aria-controls='toko' aria-expanded='false'>Profil Toko</a></li>
                    ...
                    <div id='myTabContent' class='tab-content'>
                      ...
                      <div role='tabpanel' class='tab-pane fade' id='toko' aria-labelledby='toko-tab'>
                          ...
                          <?php if (reseller($rows['id_konsumen'])!=''){ ?>
                            ...
                            <tbody>
                              <?php 
                              if (trim($rowt['foto'])==''){ $foto_user = 'blank.png'; }else{ $foto_user = $rowt['foto']; } 
                              ...
                              <tr><th width='130px' scope='row'>Nama Reseller</th> <td><?php echo $rowt['nama_reseller']?></td></tr>
                              ...
                              <tr><th scope='row'>Kontak Toko</th> <td><?php echo $rowt['no_telpon']?></td></tr>
                          ...
                          <?php }else{ echo "<center style='color:red; padding:80px 0px'>Maaf, Konsumen ini belum memiliki Toko.</center>"; } ?>
                          </div>
                      </div>

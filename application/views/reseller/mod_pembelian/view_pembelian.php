                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                ...
                                if ($row['proses']=='0'){
                                  echo "<a class='btn btn-success btn-xs' title='Konfirmasi Pemabayaran' href='".base_url().$this->uri->segment(1)."/konfirmasi_pembayaran/$row[id_penjualan]'> Pembayaran</a>
                                  ...
                                  echo "<a class='btn btn-default btn-xs' title='Konfirmasi Pemabayaran' href='#' onclick=\"return alert('Maaf, Transaksi ini sudah di konfirmasi untuk pembayarannya!')\"> Pembayaran</a>

        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <?php 
                echo "<li><a href='".base_url().$this->uri->segment(1)."/rekening'><i class='fa fa-money'></i> No Rekening</a></li>";
                // echo "<li><a href='".base_url().$this->uri->segment(1)."/keterangan'><i class='fa fa-circle-o'></i> Info/Keterangan</a></li>";
                echo "<li><a href='".base_url().$this->uri->segment(1)."/produk'><i class='fa fa-th-list'></i> Data Produk</a></li>";
                echo "<li><a href='".base_url().$this->uri->segment(1)."/alamat_cod'><i class='fa fa-home'></i> Alamat COD</a></li>";
            ?>
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <?php 
                        ...
                        echo "<li><a href='".base_url().$this->uri->segment(1)."/withdraw'><i class='fa fa-circle-o'></i> Tarik Dana (Withdraw)</a></li>";
                        // echo "<li><a href='".base_url().$this->uri->segment(1)."/pembayaran_konsumen'><i class='fa fa-circle-o'></i> Pembayaran Konsumen</a></li>";
                    ?>
                </ul>
            </li>
          
            <li><a href="<?php echo base_url(); ?>reseller/upgrade"><i class="fa fa-star text-yellow"></i> <span class='blink_me'>Upgrade Akun</span></a></li>

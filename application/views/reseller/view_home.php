...
$penjualan_ongkir = $this->model_reseller->penjualan_ongkir($this->session->id_reseller)->row_array();
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo "Rp ".rupiah(penjualan($this->session->id_reseller,'4')); ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
            </a>

            <a style='color:#000' href='<?php echo base_url(); ?>reseller/penjualan'>
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                <span class="info-box-icon bg-green"><i class="fa fa-shopping-cart"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">Modal Penjualan</span>
                  <span class="info-box-number"><?php echo "Rp ".rupiah(modal($this->session->id_reseller,'4')); ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
            </a>

            <a style='color:#000' href='<?php echo base_url(); ?>reseller/withdraw'>
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                <span class="info-box-icon bg-yellow"><i class="glyphicon glyphicon-briefcase"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">Saldo</span>
                  <span class="info-box-number"><?php echo "Rp ".rupiah(penjualan($this->session->id_reseller,'4')-$tarik['total']); ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
            </a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo "Rp ".rupiah($tarik['total']); ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
            </a>
                ...
                <h3 class="box-title">Selamat datang Reseller!</h3>
                  ...
                  Silahkan mengelola Semua data melalui menu yang sudah kita sediakan dibelah kiri anda, berikut data profile anda : <br><br>
                      ...
                      <dl class="dl-horizontal">
                          ...
                          <dt>Daerah</dt>   <dd><?php echo kecamatan($rows['kecamatan_id'],$rows['kota_id']); ?></dd>
                    ...
                    <hr style='margin:7px'>
                    <a class='btn btn-primary btn-block' href="<?php echo base_url().$this->uri->segment(1); ?>/edit_reseller/<?php echo $this->session->id_reseller; ?>">Edit Profile</a>

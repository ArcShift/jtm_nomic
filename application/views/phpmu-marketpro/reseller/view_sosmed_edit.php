            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 ">
                    <?php
                      ...
                      echo "<button type='submit' name='submit' class='ps-btn btn-block'><center><i class='icon-pen'></i> Simpan Sosial Media</center></button>";
                    ...
                    <figure class="ps-block--vendor-status biodata">
                        <?php 
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Facebook</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='a' class='form-control form-mini' value='".($ex[0] == '' ? '-' : $ex[0])."'>
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Twitter</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='b' class='form-control form-mini' value='".($ex[1] == '' ? '-' : $ex[1])."'>
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Instagram</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='c' class='form-control form-mini' value='".($ex[2] == '' ? '-' : $ex[2])."'>
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Whatsapp</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='d' class='form-control form-mini' value='".($ex[3] == '' ? '-' : $ex[3])."'>
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Telegram</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='e' class='form-control form-mini' value='".($ex[4] == '' ? '-' : $ex[4])."'>
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Youtube</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='f' class='form-control form-mini' value='".($ex[5] == '' ? '-' : $ex[5])."'>
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>LinkedIn</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='g' class='form-control form-mini' value='".($ex[6] == '' ? '-' : $ex[6])."'>
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Google+</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='h' class='form-control form-mini' value='".($ex[7] == '' ? '-' : $ex[7])."'>
                              </div>
                            </div>";
                        ?>
                    </figure>

              ...
              <?php echo "<form action='".base_url()."produk/selesai_belanja' method='POST'>"; ?>
                ...
                <?php 
                  echo "<div class='form-group row' style='margin-bottom:5px'>
                        <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Nama anda</label>
                        <div class='col-sm-10'>
                            <input type='text' name='nama' class='form-control form-mini' placeholder='- - - - - - - - -' autocomplete='off'>
                        </div>
                        </div>
                        ...
                        <div class='col-sm-10'>
                            <div class='form-row'>
                                <div class='form-group col-md-6' style='margin-bottom:5px'>
                                    <input type='number' name='telpon' class='form-control form-mini' placeholder='No Hp/Telpon' autocomplete='off'>
                                </div>
                                <div class='form-group col-md-6' style='margin-bottom:5px'>
                                <input type='email' name='email' class='form-control form-mini' placeholder='- - - - - - @mail.com' autocomplete='off'>
                                </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class='col-sm-10'>
                            ...
                            <input type='text' name='alamat' class='form-control form-mini' placeholder='Nama Jalan, No Rumah/Kantor anda..' autocomplete='off'>
                        </div>
                        </div>
                  
                  

                        <table class='table ps-table--shopping-cart table-sm'>
                          <thead>
                            <tr bgcolor='#e3e3e3'>
                              <th>Nama Produk</th>
                              <th>Total</th>
                          ...
                          echo "<tr>
                                    ...
                                    <div class='ps-product--cart'>
                                        ...
                                        <div class='ps-product__content'>
                                          ...
                                          <br><small><i class='text-success'>Catatan : $row[keterangan_order]</i></small>
                                        </div>
                                    </div></td>
                    ...
                    <div class="ps-block--shopping-total">
                        <div class="ps-block__content">
                            ...
                            <div class="ps-block__header">
                                ...
                                <p>Ongkos Kirim <span> <input type='text' id='ongkir_view' style='background:none; text-align:right' value='0' disabled/></span></p>

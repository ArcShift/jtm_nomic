            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 ">
                    <?php
                      ...
                      echo "<div style='font-size:16px; padding:10px 0px'>Sisa Saldo <b class='pull-right'>Rp ".rupiah(saldo(reseller($this->session->id_konsumen)))."</b></div>
                      
                      <a href='".base_url()."members/edit_profile' class='ps-btn btn-block'><center><i class='icon-pen'></i> Edit Biodata Diri</center></a>";
                ...
                <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 ">
                    <figure class="ps-block--vendor-status biodata">
                        <?php 
                            ...
                            <div class='form-group row' style='margin-bottom:5px'>
                            <label class='col-sm-3 col-form-label' style='margin-bottom:1px'>Terdaftar pada</b></label>
                            <div class='col-sm-9'>

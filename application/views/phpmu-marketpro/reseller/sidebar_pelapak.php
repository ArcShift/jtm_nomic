  ...
  <div class="ps-block--vendor">
      ...
      <div class="ps-block__container">
          <div class="ps-block__header">
            <?php echo cek_paket_icon($rows['id_reseller']); ?><h4><?php echo $rows['nama_reseller']; ?></h4>
          ...
          <div class="ps-block__footer">
              <p>Hubungi kami di : <strong>+<?php echo $rows['no_telpon']; ?></strong>atau Klik Tombol Dibawah ini </p><a class="ps-btn ps-btn--fullwidth" target='_BLANK' href="<?php echo "https://api.whatsapp.com/send?phone=$rows[no_telpon]&amp;text=Assalamualaikum,%20Haloo%20$rows[nama_reseller],%20Saya%20Mau%20Bertanya..."; ?>">Hubungi Kami</a>
          </div>
      </div>
  </div>
</div>

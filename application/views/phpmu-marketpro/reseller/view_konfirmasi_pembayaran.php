        ...
        <div class="ps-section__content">
            <?php 
              ...
              <?php
                  ...
                  <div class='form-group'><label>Total Tagihan/Transfer</label> <input type='text' name='b' class='form-control font-weight-bold text-success' value='Rp ".rupiah(($total['total']-$total['diskon_total'])+$total['ongkir'])."' required></div>

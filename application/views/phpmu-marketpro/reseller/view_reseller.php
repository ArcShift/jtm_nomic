                  ...
                  echo "<div class='col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 '>
                      <article class='ps-block--store-2'>
                          <div class='ps-block__content bg--cover' data-background='".base_url()."asset/images/default-store-banner.png' style='background: url(&quot;".base_url()."asset/images/default-store-banner.png&quot;);'>
                              <figure>
                              ".cek_paket_icon($row['id_reseller'])."<h4>$row[nama_reseller]</h4>
                                  <p>$kota <br> $row[alamat_lengkap]</p>
                                      <p><i class='icon-telephone'></i> $row[no_telpon]</p>
                              </figure>
                          </div>
                          <div class='ps-block__author'><a class='ps-block__user' href='#'><img src='".base_url()."asset/foto_user/$foto_user' alt=''></a><a class='ps-btn' href='".base_url()."produk/produk_reseller/$row[id_reseller]'>Kunjungi Toko</a></div>
                      </article>
                  </div>";
                }
              ?>

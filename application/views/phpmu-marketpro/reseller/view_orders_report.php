            ...
            <div class="row">
                ...
                <div class='col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12 biodata notif'>
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pending-tab" data-toggle="tab" href="#pending" role="tab" aria-controls="pending" aria-selected="true">Menunggu Konfirmasi <span class="badge badge-secondary"><?php echo total_order('0',$this->session->id_konsumen); ?></span></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <?php 
                          ...
                          <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Invoice / Seller</label>
                            <div class='col-sm-10'>
                              ...
                              <a href='".base_url()."members/detail_reseller/$row[id_reseller]'><span class='text-success text-uppercase'>$row[nama_reseller]</span></a><br>
                            </div>
                          </div>
                          ...
                          <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Total Belanja</b></label>
                            <div class='col-sm-10'>
                              <span class='text-danger'>Rp ".rupiah($total['total']+$row['ongkir'])." ($produk Produk)</span>
                            </div>
                          </div><br>";
                            $no++;
                          }

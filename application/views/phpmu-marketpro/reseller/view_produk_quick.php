...
<div class="ps-product__desc">
    <p>Penjual :<a href="<?php echo base_url()."produk/produk_reseller/$record[id_reseller]"; ?>"><strong> <?php echo $rows['nama_reseller']; ?></strong></a></p>
...
?>
    ...
    <div class='pull-right'>
        ...
        <button type='submit' name='keranjang' class="ps-btn ps-btn--black ml-3" style='color:#fff'>Masukkan Keranjang</button>

            ...
            <div class="ps-tabs">
                ...
                <form action="<?php echo base_url(); ?>auth/login" method="POST">
                    <div class="ps-form__content">
                        ...
                        <div class="form-group">
                            <input class="form-control" name='a' type="text" placeholder="Username, Email atau No. Handphone" autofocus required>
                        </div>
                        <div class="form-group form-forgot">
                            <input class="form-control" name='b' type="password" placeholder="Kata Sandi" required>
                ...
                <form action="<?php echo base_url(); ?>auth/register" class='auth' method="POST">
                    <div class="ps-form__content">
                        ...
                        <div class="form-group" style='margin-bottom:10px'>
                            <input class="form-control form-auth" name='username' value='<?php if (isset($first_name)){ echo strtolower($first_name); } ?><?php if (isset($last_name)){ echo strtolower($last_name); } ?>' type="text" placeholder="Username" autofocus required>
                        </div>
                        <div class="form-group" style='margin-bottom:10px'>
                            <input class="form-control form-auth" name='a' value='<?php if (isset($email)){ echo $email; } ?>' type="email" placeholder="E-mail" required>
                        </div>
                        <div class="form-group" style='margin-bottom:10px'>
                            <input class="form-control form-auth" name='b' type="number" placeholder="Nomor Telepon" required>
                        </div>
                        <div class="form-group" style='margin-bottom:10px'>
                        ...
                        <div class='form-group row'>
                            <div class='col-sm-12'>
                              <div class='row'>
                                <div class='col'>
                                    <input class="form-control form-auth" name='password' type="password" placeholder="Password" required>
                                </div>
                                <div class='col'>
                                    <input class="form-control form-auth" name='repassword' type="password" placeholder="Konfirmasi Password" required>
                                </div>
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group submit">
                            <button type='submit' name='submit2' class="ps-btn ps-btn--fullwidth gray-btn">Daftar</button>
                            <?php 
                                $ci = & get_instance();
                ...
                <form action="<?php echo base_url(); ?>auth/lupass" method="POST">
                    <div class="ps-form__content">
                        ...
                        <div class="form-group">
                            <input class="form-control" name='a' type="email" placeholder="Username, Email" required>
                        </div>
                        <div class="form-group">

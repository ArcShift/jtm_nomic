...
?>
        ...
        <?php 
          ...
          echo "<tr><td>$no</td>
                    ...
                    <td><a style='color:#ab0534' href='".base_url()."produk/detail/$row[produk_seo]'><b>$row[nama_produk]</b></a>
                        ...
                        <br>Warna&nbsp; : <input type='text' name='warna$no' style='display:inline-block; margin-bottom:3px' placeholder='Contoh : Putih, Hitam, Biru'>
                                      <br>Ukuran : <input type='text' name='ukuran$no' style='display:inline-block' placeholder='Contoh : S, M, L, XL'></td>
      ...
      <div class='col-md-4 col-xs-6 pull-right'>
          ...
          <button type='submit' name='submit' class='btn btn-success btn-flat btn-sm'>Lakukan Pembayaran</button>
          </center>
